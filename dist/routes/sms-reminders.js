...
exports.scheduleReminder = exports.sendTestWhatsApp = exports.sendTestWhatsAppSimple = exports.sendWhatsAppReminderEndpoint = void 0;
...
const sendWhatsAppReminderEndpoint = async (req, res) => {
    try {
        ...
        console.log(`WhatsApp Reminder - Phone: ${phone}, Task: ${taskTitle}, Due: ${dueDate}`);
...
exports.sendWhatsAppReminderEndpoint = sendWhatsAppReminderEndpoint;
...
exports.sendTestWhatsAppSimple = sendTestWhatsAppSimple;
...
//# sourceMappingURL=sms-reminders.js.map